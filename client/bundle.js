...
var __vueify_style_dispose__ = require("vueify/lib/insert-css").insert("div[data-v-64088a62]{\n\tdisplay: inline-block;\n\tbackground: yellow;\n}")
;(function(){
//
//
//
...
__vue__options__.staticRenderFns = []
__vue__options__._scopeId = "data-v-64088a62"
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-64088a62", __vue__options__)
  } else {
    hotAPI.reload("data-v-64088a62", __vue__options__)
  }
})()}
